  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${gradient ?? 'from-sage-300/20 to-mist-300/20'} flex flex-col items-center justify-between px-6 py-16 safe-top`}>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-stone-600 text-sm mt-2">{title}</p>
      </div>

      {/* Stats + Mood */}
      <div className="flex flex-col items-center gap-6 w-full">
        {/* Time */}
        <div className="bg-cream-100/60 backdrop-blur rounded-3xl px-8 py-5 text-center w-full max-w-xs shadow-soft">
        ...
        {/* Streak */}
        {streak > 0 && (
          <div className="flex items-center gap-3 bg-cream-100/60 backdrop-blur rounded-3xl px-6 py-4 w-full max-w-xs shadow-soft">
            <div className="w-10 h-10 rounded-2xl bg-orange-900/20 flex items-center justify-center">
        ...
        {moodBefore && !moodAfter && (
          <div className="bg-cream-100/60 backdrop-blur rounded-3xl px-6 py-5 w-full max-w-xs shadow-soft">
            <MoodSelector
        ...
        {moodBefore && moodAfter && (
          <div className="bg-cream-100/60 backdrop-blur rounded-3xl px-6 py-4 w-full max-w-xs shadow-soft text-center">
        ...
        <p className="text-stone-600 text-sm italic text-center px-4">"{message}"</p>
      </div>
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs">
        ...
        <button
          onClick={() => navigate(-2)}
          className="w-full bg-cream-100/60 backdrop-blur text-stone-600 rounded-2xl py-3.5 font-medium text-sm flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
        >
          <RotateCcw size={16} />
          Meditate again
        </button>
